								...
								<div class="form-bottom">
									...
									<div class="form-group">
										...
										<label class="Car-text">Owner's Full Name :</label> <input
											...
											title="Please Enter Last Name" value="<%=(String) session.getAttribute("Fullname")%>"
										...
										<div class="form-group">
											...
											<%
												...
												try {
													...
													String query1 = "select FINANCIERNAME from royalsundaram where FIN_CATEGORY_CODE like ?";
