											...
											<form id="PostForm" name="PostForm" autocomplete="off"
												...
												<fieldset>
													...
													<input type="hidden" name="reqType" id="reqType"
														value="JSON"> <input type="hidden" name="process"
														value="paymentOption"> <input type="hidden"
														name="apikey" id="apikey"
														value="310ZQmv/bYJMYrWQ1iYa7s43084="> <input
													...
													<input type="hidden" value="" name="nonelc_value"
														...
														value="billDesk" name="paymentType" />
