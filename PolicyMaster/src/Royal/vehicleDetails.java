...
public class vehicleDetails {
	...
	public String toString() {
		return "vehicleDetails [carRegisteredCity=" + carRegisteredCity + ", vehicleModelCode=" + vehicleModelCode
				...
				+ ", isTwoWheelerFinancedValue=" + isTwoWheelerFinancedValue + ", electricalAccessories="
				+ electricalAccessories + ", electronicAccessoriesDetails=" + electronicAccessoriesDetails
				+ ", nonElectricalAccesories=" + nonElectricalAccesories + ", nonElectronicAccessoriesDetails="
